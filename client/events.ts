/**
 * Client-side mirror of the host's session-event contract (src/events/).
 * The client conversation-node engine matches raw session events by type
 * string; these declarations keep the client's SessionEventMap view typed.
 */
