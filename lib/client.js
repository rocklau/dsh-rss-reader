...
var TYPERT_REMOTE = {
  ...
  descriptors: [
    ...
    descriptor("addFeed", [json("url", external_exports.string()), json("name", external_exports.string().optional())], addFeedResultSchema),
    descriptor("listArticles", [json("limit", external_exports.number().optional())], external_exports.array(articleSchema)),
    descriptor("listArticlesByDate", [json("date", external_exports.string())], external_exports.array(articleSchema)),
    descriptor("listArticlesByFeed", [json("feedUrl", external_exports.string()), json("limit", external_exports.number().optional())], external_exports.array(articleSchema)),
    descriptor("searchArticles", [json("query", external_exports.string()), json("limit", external_exports.number().optional())], external_exports.array(articleSchema)),
    descriptor("getArticle", [json("articleId", external_exports.string())], articleSchema.nullable()),
    ...
    descriptor("listNotes", [json("articleId", external_exports.string())], noteListSchema),
    descriptor("activity", [json("limit", external_exports.number().optional()), json("offset", external_exports.number().optional())], activityPageSchema),
    descriptor("exportReview", [json("days", external_exports.number().optional())], external_exports.string()),
    descriptor("syncStatus", [], syncStatusSchema),
    descriptor("warmSync", [json("limit", external_exports.number().optional()), json("timeoutMs", external_exports.number().optional()), json("reason", external_exports.string().optional()), json("sessionId", external_exports.string().optional())], syncResultSchema),
...
function NotesView({ api }) {
  ...
  const filtered = items.filter((item) => {
    ...
    if (filter === "Week") return now.getTime() - time.getTime() < 7 * 864e5;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "ob-notes", children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "ob-toolbar", style: { border: "none", padding: "0 0 12px" }, children: FILTERS.map((name) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { className: `ob-btn ${filter === name ? "primary" : ""}`, onClick: () => {
      setFilter(name);
      setVisible(30);
    }, children: name }, name)) }),
...
function ReaderView({ api, sessionId, onSyncDone }) {
  ...
  const [date, setDate] = (0, import_react3.useState)(() => /* @__PURE__ */ new Date());
  ...
  (0, import_react3.useEffect)(() => {
    setLoading(true);
    const load = selectedFeed !== null ? api.listArticlesByFeed(selectedFeed) : api.listArticlesByDate(fmtDate(date));
    void load.then((list) => {
      setArticles(list);
      setSelected((prev) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "ob-body", children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("aside", { className: "ob-sidebar", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { className: `ob-feed ${selectedFeed === null ? "active" : ""}`, onClick: () => setSelectedFeed(null), children: "All feeds" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("section", { className: "ob-list", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { padding: "4px 12px", color: "var(--ob-muted)", fontSize: 11 }, children: [
        selectedFeed !== null ? selectedFeed : fmtDate(date),
        " \xB7 ",
        articles.length,
        " articles"
      ] }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "ob-note-editor", style: { borderTop: "none", paddingTop: 0, marginTop: 4 }, children: [
          ...
          canDiscuss && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
            ...
            highlight !== "" && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "ob-note-card", style: { marginTop: 6 }, children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: { fontSize: 12 }, children: highlight.length > 160 ? `${highlight.slice(0, 160)}\u2026` : highlight }),
...
function RssContent({ api, sessionId, toolbar }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "openbook-rss", children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "ob-tabs", children: [
      TABS.map((item) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { className: `ob-tab ${tab === item.id ? "active" : ""}`, onClick: () => setTab(item.id), children: item.label }, item.id)),
...
// client/index.ts
var inject = ["remote", "slots", "conversationEvents", "sessions"];
function apply2(ctx) {
  const gateway = ctx.remote;
  let remoteDispose;
  void gateway.$mount(remote_default).then((dispose) => {
    remoteDispose = dispose;
  });
  ctx.effect(() => () => {
    void remoteDispose?.();
    remoteDispose = void 0;
  ...
  const goToRss = () => {
    ...
    if (!currentOk) {
      ...
      if (target !== void 0 && target !== current) sessions.open(target);
    }
    switchToRssTab();
  };
  ...
  ctx.inject(["remote.rssApi", "slots"], (scope) => {
    const remoteNs = scope.get("remote.rssApi");
